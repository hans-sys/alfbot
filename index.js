...
const config = {
    A187: '👾HANSBOT👾',
    instagram: 'https://instagram.com/_hansmlbbyt_',
    nomer: 'wa.me/6282285537176',
    aktif: '10 JAM' 
...
client.on('qr', qr => {
   ...
   console.log(`[ ${time} ] QR code is ready,Jangan Lupa Dukung Hans Ganteng Selalu)
})
...
// client.on('user-presence-update', json => console.log(json.id + ' presence is => ' + json.type)) || console.log(`${time}: Bot by ig:@hansmlbbyt`)

client.on('message-status-update', json => {
   const participant = json.participant ? ' (' + json.participant + ')' : ''
   console.log(`[ ${time} ] => bot by ig:@hansmlbbyt`)
})
